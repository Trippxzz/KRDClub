...
"""
Django settings for krdweb project.
...
SECRET_KEY = 'django-insecure-+14*d+ede4d021**a6u3e2p_k&9qp&o@*=r5)p5f(0om%=y1dp'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'builtins': [
                'krd_app.templatetags.formato_precio',
            ],
        },
    },
]

WSGI_APPLICATION = 'krdweb.wsgi.application'
